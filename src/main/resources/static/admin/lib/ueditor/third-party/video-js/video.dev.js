...
/**
 * SysUseragent for browser testing.
 * @type {String}
 * @constant
 * @private
 */
...
vjs.Player.prototype.reportSysUserActivity = function(event){
...
vjs.Player.prototype.listenForSysUserActivity = function(){
  var onMouseActivity, onMouseDown, mouseInProgress, onMouseUp,
      activityCheck, inactivityTimeout;

  onMouseActivity = this.reportSysUserActivity;
  ...
  // `this.reportSysUserActivity` simply sets this.userActivity_ to true, which
...
vjs.MediaTechController.prototype.addControlsListeners = function(){
  ...
  preventBubble = function(event){
    event.stopPropagation();
    if (userWasActive) {
      this.player_.reportSysUserActivity();
    }
  };
  ...
  // listener cancels out any reportedSysUserActivity when setting userActive(false)
