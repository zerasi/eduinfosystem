    ...
    function CodeMirror(place, givenOptions) {
        ...
        var instance = wrapper.CodeMirror = {
            ...
            setSelection: operation(function(from, to, user) {
                (user ? setSelectionSysUser : setSelection)(clipPos(from), clipPos(to || from));
            }),
        ...
        function onMouseDown(e) {
            ...
            var up = connect(targetDocument, "mouseup", operation(function(e) {
                ...
                if (cur) setSelectionSysUser(start, cur);
                e_preventDefault(e);
                focusInput();
                updateInput = true;
                move(); up();
        ...
        function setSelectionSysUser(from, to) {
        ...
        function setCursor(line, ch, user) {
            ...
            (user ? setSelectionSysUser : setSelection)(pos, pos);
        }
        ...
        function selectWordAt(pos) {
            ...
            setSelectionSysUser({line: pos.line, ch: start}, {line: pos.line, ch: end});
        }
        function selectLine(line) {
            setSelectionSysUser({line: line, ch: 0}, {line: line, ch: getLine(line).text.length});
        }
