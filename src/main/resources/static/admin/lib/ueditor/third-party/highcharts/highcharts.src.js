...
Axis.prototype = {
	...
	init: function (chart, userOptions) {
		...
		//axis.oldSysUserMin = UNDEFINED;
		//axis.oldSysUserMax = UNDEFINED;
	...
	setScale: function () {
		...
		if (isDirtyAxisLength || isDirtyData || axis.isLinked || axis.forceRedraw ||
			axis.userMin !== axis.oldSysUserMin || axis.userMax !== axis.oldSysUserMax) {
			...
			axis.oldSysUserMin = axis.userMin;
			axis.oldSysUserMax = axis.userMax;
...
Chart.prototype = {
	...
	initReflow: function () {
		...
		function reflow(e) {
			...
			if (!chart.hasSysUserSize && width && height && (target === win || target === doc)) {
	...
	setSize: function (width, height, animation) {
		...
		if (defined(width)) {
			...
			chart.hasSysUserSize = !!chartWidth;
		}
		if (defined(height)) {
