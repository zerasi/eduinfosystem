...
window.onload = function () {
    ...
    initEvent();
    initSysUserConfig( editorTable.getAttribute( "data-chart" ) );
 ...
 */
function initSysUserConfig ( config ) {
...
function setSysUserConfig ( config ) {
